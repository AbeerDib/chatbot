...
def create_prompt(query, history, retrieved_docs):
    ...
    prompt = (
        f"You are an expert assistant at the Faculty of Medicine, AUB. Answer to greetings and introducing yourself.\n"
        ...
        f"while being aware of the history. However, if none and only none of the relevent documents clearly answer/related to the question,or there's no information from the history to answer it respond with 'Sorry, I don't have an answer to your inquiry. Kindly check our website: https://www.aub.edu.lb/FM/Pages/default.aspx' "
    )
    return prompt
